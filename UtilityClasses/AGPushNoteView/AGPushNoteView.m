...
- (void)messageTapAction {
    ...
    [AGPushNoteView close];
   // [APP clickOnForgroundNotifications];
//    HomeViewController *vc = [[HomeViewController alloc]init];
//    [vc clickOnForgroundNotifications];
    AppDelegate *delegate = [[AppDelegate alloc]init];
    [delegate clickOnForgroundNotifications];

    NSLog(@"Click on Forground");
...
- (IBAction)btnLogoOnclick:(id)sender {
     [AGPushNoteView close];
