//
//  PedometerKMsTableViewController.swift
//  Stetho Update
//
...
class PedometerKMsTableViewController: UITableViewController {
    
    var kmsDayMOArr: [StepDayMO] = []
    ...
    override func viewDidLoad() {
        ...
        addBarButtonItem()
        kmsDayMOArr = DBManager.sharedDBManager.fetchStepsDatafromDB(ascending: false)
    ...
    override func tableView(_ tableView: UITableView, numberOfRowsInSection section: Int) -> Int {
        ...
        return kmsDayMOArr.count//stepsDayMOArr[section].stepTimeInterval!.count
    }
...
//        let dateStr = kmsDayMO.date?.components(separatedBy: "at")[0]
        let dateComponents: [String] = kmsDayMO.date!.components(separatedBy: "-")
        ...
        pedometerDataTableViewCell.lblTotalSteps.text = String(format: "%.2g KM", kmsDayMO.totalSteps/1250.roundToPlaces(places: 2))//"\(stepDayMO.totalSteps)"
       // pedometerDataTableViewCell.lblRating.text = String(format: "%.1f", (((kmsDayMO.totalSteps/averageSteps)*100)*5)/100)
        pedometerDataTableViewCell.lblRating.text = String(format: "%.1f", (((kmsDayMO.totalSteps/kmsDayMO.targetSteps)*100)*5)/100)
