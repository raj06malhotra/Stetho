...
class WaterReminderViewController: UIViewController, UITableViewDelegate, UITableViewDataSource {
    @IBOutlet weak var tableView: UITableView!
    @IBOutlet weak var pickerView: UIDatePicker!
    @IBOutlet weak var pickerBGView: UIView!
    
    var timeArr = ["6:00 AM", "10:00 AM", "1:00 PM", "4:00 PM", "6:00 PM", "9:00 PM"]
...
//        self.tabBarController?.navigationItem.title = "Hello World"
        addBarButtonItem()
    }
