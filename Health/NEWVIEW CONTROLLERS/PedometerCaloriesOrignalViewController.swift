//
//  PedometerCaloriesOrignalViewController.swift
//  Stetho Update
//
//  Created by Administrator on 01/08/17.
//  Copyright © 2017 Administrator. All rights reserved.
//

import UIKit

class PedometerCaloriesOrignalViewController: UITableViewController {
...
//        let secs = stepDayMO.stepTimeInterval?.reduce(0) { $0 + ($1 as! PedometerMO).timeIntervalSecs}
        pedometerDataTableViewCell.lblTotalSteps.text = (String(format:"%.2g Calories", (stepDayMO.totalSteps/20.0).roundToPlaces(places: 2)))
